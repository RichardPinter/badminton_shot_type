...
def get_stroke_types(side='Both', pad_to_same_len=False):
    class_ls = [
        ...
        'clear', 'drive', 'back-court drive', 'drop', 'passive drop', 'push',
        'rush', 'defensive return drive', 'cross-court net shot', 'short service', 'long service'
    ]
    if pad_to_same_len:
    ...
    match side:
        case 'Both':
            class_ls = ['Top_'+s for s in class_ls] + ['Bottom_'+s for s in class_ls] + ['none']
        case 'Top':
            class_ls = ['Top_'+s for s in class_ls] + ['none']
        case 'Bottom':
            class_ls = ['Bottom_'+s for s in class_ls] + ['none']
